...
import { Circle, Rect, Path, Image, Group, Text, GroupProps } from './index';
// @ts-expect-error
...
function House(props) {
	return (
		<Group {...props} width={220} height={205}>
			<Rect x={90} y={140} width={40} height={60} fill="red" />
			<Circle radius={5} x={115} y={165} fill="gold" stroke="black" />
			<Rect
				x={35}
				y={90}
				width={150}
...
function Header(props: GroupProps) {
	return (
		<Group {...props} width={1280 - 60} height={75}>
			<Rect y={74} width="100%" fill="white" height={1} />
			<Logo x={-75} y={-72} scaleX={0.2} scaleY={0.2} />
			<Text
				x={70}
				y={24}
				fontSize={36}
				fontFamily="Nintendo Switch UI"
				fill="white"
			>
				Canvas Showcase
			</Text>
...
function Footer(props: GroupProps) {
	return (
		<Group {...props} width={1280 - 60} height={75}>
			<Rect width="100%" fill="white" height={1} />
			<Text
				fill="white"
				fontSize={24}
				fontFamily="Nintendo Switch UI"
...
function Sidebar(props: GroupProps) {
	return (
		<Group {...props} width={410} height={570}>
			<Rect width="100%" height="100%" fill="#323232" />
			<Button x={75} y={24} selected active>
				One
			</Button>
			<Button x={75} y={99} active>
				Two
			</Button>
			<Button x={75} y={174}>
				Three
...
function Button(
	...
	return (
		<Group {...props} width={305} height={75}>
			<Rect
				width="100%"
				height="100%"
				stroke={stroke}
			...
			/>
			{props.active ? (
				<Rect x={12} y={12} fill="#01ffc5" width={5} height={52} />
			) : null}
			<Text
				fill={props.active ? '#01ffc5' : 'white'}
				fontSize={20}
				fontFamily="Nintendo Switch UI"
				x={25}
				y={30}
...
function Logo(props: GroupProps) {
	return (
		<Group {...props} width={223} height={223}>
			<Path
